 ...
 */
final class Version20241025135113 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE book ADD ref INT NOT NULL, ADD category VARCHAR(50) NOT NULL, ADD publicationdate DATE DEFAULT NULL, ADD published TINYINT(1) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE book DROP ref, DROP category, DROP publicationdate, DROP published');
    }
}
